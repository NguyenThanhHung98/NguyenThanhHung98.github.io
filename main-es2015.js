...
let AppRoutingsModule = class AppRoutingsModule {
};
...
/* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm2015/http.js");
...
let WordsComponent = class WordsComponent {
    ...
    getShowStatus(memorized) {
        ...
        const dkXemTuDaNho = this.filterStatus === "XEM_TU_DA_NHO" && memorized;
        const dkXemTuChuaNho = this.filterStatus === "XEM_TU_CHUA_NHO" && !memorized;
